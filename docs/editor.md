...
`editor/` την παράγει από C#· τέσσερα σημεία δεν επιβίωσαν την επαφή.
...
τελευταία βρέθηκαν όταν γράφτηκε ο exporter.
...
**Ένα πέμπτο που ΔΕΝ είναι λάθος και αξίζει να σημειωθεί**: το `EncodeMode0`
